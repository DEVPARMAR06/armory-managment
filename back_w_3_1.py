...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 21:00:00 2021
...
import back_window_3 as b_w_3

class w_3_1:
    def __init__(self,root):
        self.root=root
        self.root.config(bg="black")
        self.root.title("LIST-OF-ALL-ALLOTED-GUN")
    ...
    def back(self):
        self.rakh()
        b_w_3.bw_3(self.root)
    def file_setup(self):
        f=open("gun_allotment.txt",'r')
        f1=open("list_of_allocated.txt",'w')
        f1.write("ID".rjust(15," "))
